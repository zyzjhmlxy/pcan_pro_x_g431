...
USBD_ClassTypeDef usbd_pcanpro =
{
  ...
  .SOF = NULL,                                //sof_handler,
  .IsoINIncomplete = NULL,
  .IsoOUTIncomplete = NULL,
  .GetHSConfigDescriptor = NULL,              //device_get_hs_cfg,
  .GetFSConfigDescriptor = device_get_fs_cfg,
  .GetOtherSpeedConfigDescriptor  = NULL,     //device_get_other_speed_cfg,
  .GetDeviceQualifierDescriptor = NULL,       //device_get_device_qualifier,
